...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 16 déc. 2022 à 10:19
...
INSERT INTO `communities` (`id`, `name`, `diocese`, `country`) VALUES
(46, '  Emmanuel House Theology ', 'Kampala', 'Uganda'),
(49, 'ST MBAGATUZINDE KATUA', 'NAIROBI-KATUA', 'Uganda'),
(50, 'St Monica Njiru Parish', 'ARCHDIOCESE OF NAIROBI', 'Kenya'),
(53, 'St Monica Njiru Parish', 'NAIROBI', '  Kenya');
...
(8, 1595915639, 1207969711, 'ok'),
(9, 1595915639, 1207969711, 'ok');
...
INSERT INTO `register_candidate` (`id`, `image`, `email`, `password`, `phone`, `name`) VALUES
(51, 'ecum.jfif', 'dieudonnet@gmail.com', '1234', ' 0787991880 ', ' Dieudonne '),
(52, 'livingOK.jpg', 'dieudonnetsongo@gmail.com', '1234', ' 0706571995 ', ' Dieudonn '),
(53, 'photo1.jpeg', 'dieudonnets@gmail.com', '1234', ' 0706571995 ', ' Dieudonne ');
...
CREATE TABLE `religious_tb` (
  ...
  `country` varchar(30) DEFAULT NULL,
  `cur_country` varchar(50) DEFAULT NULL,
  `community` varchar(50) DEFAULT NULL,
  `phone` varchar(30) DEFAULT NULL,
...
INSERT INTO `religious_tb` (`id`, `image`, `name`, `status`, `country`, `cur_country`, `community`, `phone`, `code`, `email`, `password`, `updated_time`, `temp_v_date`, `perp_v_date`, `deaconate_date`, `priesthood_date`, `role`) VALUES
(10, 'bayard2.jfif', 'Dido', 'phylosophy', '  Kenya', 'kenya', 'Emmanuel House', '0787991880', NULL, 'dieudonne@gmail.com', '1234', '2022-12-14 14:27:35', '12 June 2015', '14 July 2022', '  14 June 2015', '45 November 2028', 'religious'),
(8, 'living.jfif', ' John Kiarie ', 'theology', ' Kenya ', 'uganda', ' Kijenge ', ' 0706571995 ', 'D6BQ98JEIS', 'dieudonnetsongo@gmail.com', 'dieudonne12', '2022-12-15 14:54:32', ' 12 June 2015 ', ' 14 July 2022 ', '   14 June 2015 ', ' not yet ', 'admin'),
(11, 'ecumenism--5.png', 'Tsongo Dieudonne', 'pastoral', '  Kenya', 'tanzania', '  Njiru oooop', '+25420045500000', NULL, 'tsongo@gmail.com', '1234', '2022-12-14 14:28:08', '12 June 2015', '14 July 2022', 'not done', '   14 July 2019', 'religious'),
(12, 'ecumenism--5.png', 'Dieudonne', 'diaconate', 'uganda', 'kenya', 'Njiru', '0706571995', 'D6BQ98JEIS', 'dieudonnetsongo@gmail.com', 'dieudonne12', '2022-12-15 14:54:32', '10/sept/1985', NULL, NULL, NULL, NULL);
...
CREATE TABLE `statistics` (
  ...
  `novices` int(20) DEFAULT NULL,
  `philosophers` int(20) DEFAULT NULL,
  `theologians` int(20) DEFAULT NULL,
  `deacons` int(20) DEFAULT NULL,
  `priests` int(20) DEFAULT NULL,
  `missionaries` int(20) DEFAULT NULL,
  `totalreligious` int(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `statistics` (`year`, `novices`, `philosophers`, `theologians`, `deacons`, `priests`, `missionaries`, `totalreligious`) VALUES
(2000, 0, 0, 0, 0, 0, 0, 0),
(2001, 8, 17, 15, 8, 13, 14, 50),
(2002, 14, 11, 25, 9, 14, 6, 52),
(2003, 8, 11, 5, 9, 17, 11, 45),
(2004, 9, 15, 15, 19, 17, 4, 49),
(2005, 8, 12, 11, 9, 4, 7, 51);
...
(2, 1207969711, 'Dieudonne', 'Tsongo', 'dieudonnetsongo@gmail.com', '81dc9bdb52d04dc20036dbd8313ed055', '1670420778photo4.jpeg', 'Offline now'),
(3, 1429042403, 'Clara', 'sekeravithi', 'clara@gmail.com', '81dc9bdb52d04dc20036dbd8313ed055', '1671038346photo3OK.jpg', 'Offline now');
...
--
ALTER TABLE `statistics`
  MODIFY `year` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2006;
