...
<div class="row">
    <?php      
      $select_stmt = $connection->prepare("SELECT * FROM theology"); //sql select query
      $select_stmt->execute();
      ...
      <li data-bs-target="#blogCarousel" data-bs-slide-to="1"></li>
            ...
            <div class="carousel-inner ">
              <div class="carousel-item active">
                <div class="row">
                  <?php
                      $select_stmt = $connection->prepare("SELECT * FROM theologians limit 3 "); //sql select query
                        $select_stmt->execute();
                        while($row=$select_stmt->fetch(PDO::FETCH_ASSOC))
                        {
                        ?>
                ...
                <div class="carousel-item">
                  <div class="row">
                    <?php
                        $select_stmt = $connection->prepare("SELECT * FROM theologians limit 3,5 "); //sql select query
                          $select_stmt->execute();
                          while($row=$select_stmt->fetch(PDO::FETCH_ASSOC)){
                          ?>
                    <div class="col-4">
...
<div class="row">
    <?php      
      $select_stmt = $connection->prepare("SELECT * FROM theology_infor"); //sql select query
      $select_stmt->execute();
        while($row=$select_stmt->fetch(PDO::FETCH_ASSOC))
        {
        ?>
