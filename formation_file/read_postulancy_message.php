...
if(isset($_REQUEST['delete_id'])){
	...
	header("Location:read_postulancy_message.php");
}
			...
			<div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           <h3><a href="create_lay.php"><span class="glyphicon glyphicon-plus"></span>&nbsp; Add Postulancy message</a></h3>
                        </div>
                        <!-- /.panel-heading -->
			...
			while($row=$select_stmt->fetch(PDO::FETCH_ASSOC))
			{
				?>
					...
					<tr>
						...
						<iframe style="width: 100%; height: 80%"  src="<?php echo $row['video']; ?>"></iframe>
						<td><?php echo $row['descriptionvideo']; ?></td>
						<td><a href="edit_postulancy_message.php?update_id=<?php echo $row['id']; ?>" class="btn btn-warning">Edit</a></td>
