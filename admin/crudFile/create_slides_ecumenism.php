			...
			{				
				...
				if(empty($image_file)){
						$errorMsg = "Please Select Image";
				  		...
				  		if(!isset($errorMsg)){
				  			$insert_stmt = $connection->prepare('INSERT INTO slides_ecumenism(image, title, description) VALUES(:image, :title, :description)'); // sql insert query
				  				...
				  				if($insert_stmt->execute()){
				  					...
				  					header("refresh:1;read_slides_ecumenism.php"); //refresh 3 second and redirext to the read page
				  				}
				  		}
