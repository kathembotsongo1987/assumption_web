...
if(isset($_REQUEST['delete_id'])){
	...
	$delete_stmt = $connection->prepare('DELETE FROM music WHERE id =:id');
	$delete_stmt->bindParam(':id',$id);
	$delete_stmt->execute();

	header("Location:read_music.php");
}
						...
						<table class="table table-striped table-bordered table-hover" style="text-align: center;">
							...
							<tbody>
								...
								<tr>
									...
									<td><a href="edit_music.php?update_id=<?php echo $row['id']; ?>" class="btn btn-warning">Edit</a></td>
