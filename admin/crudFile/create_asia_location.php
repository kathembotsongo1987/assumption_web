			...
			<div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           <h1 style="color: blue; text-align: center;">Data insertion in Asia</h1>
                        </div>
                        <!-- /.panel-heading -->
			...
			{				
				...
				if (empty($Country)) {
					...
					$errorMsg = "please Enter the number of communities";	
				  		...
				  		if(!isset($errorMsg)){
				  			$insert_stmt = $connection->prepare('INSERT INTO asia_location(country, no_community) VALUES(:country, :no_community)'); // sql insert query
				  				...
				  				if($insert_stmt->execute()){
				  					...
				  					header("refresh:3;read_asia_location.php"); //refresh 3 second and redirext to the read page
				  				}
				  		}
