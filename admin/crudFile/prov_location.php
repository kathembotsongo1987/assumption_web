			...
			<div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           <h1 style="color: blue; text-align: center;">These are dynamic location at the vice provincial level level</h1>
                        </div>
                        <!-- /.panel-heading -->
...
<form method="post" class="form-horizontal" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<div class="col-sm-6">
				<input type="text" name="txt_city" class="form-control" placeholder="enter city">
			</div>
	</div>
	<div class="form-group">
		<label class="col-sm-3 control-label">Communities</label>
		<div class="col-sm-6">
				<input type="text" name="txt_community" class="form-control" placeholder="enter community">
			</div>
	</div>
		...
		if(isset($_REQUEST['btn_insert']))
		{
			...
			{				
				...
				if(empty($Country)){
					...
					$errorMsg = "please Enter communities";	
				}
				
				  		if(!isset($errorMsg)){
				  			$insert_stmt = $connection->prepare('INSERT INTO vp_location(country, city, community) VALUES(:country, :city, :community)'); // sql insert query
				  				...
				  				if($insert_stmt->execute()){
				  					...
				  					header("refresh:3;prov_location.php"); //refresh 3 second and redirext to the read page
				  				}
				  		}
