...
if(isset($_REQUEST['btn_update'])){
	try
		...
		if(!isset($errorMsg)){
			$upldate_stmt = $connection->prepare('UPDATE communitieskenya SET name=:name_up, diocese=:diocese_up WHERE id=:id'); //slq update the query.			
			...
			if($upldate_stmt->execute()){
				...
				header("refresh:1; read_cty_kenya.php");//reflesh 3 second and redirect to read.php page.
			}
		}
	}
	catch(PDOException $e){
