			...
			<div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           <h1 style="color: blue; text-align: center;"> Create temporary vows</h1>
                        </div>
                        <!-- /.panel-heading -->
				...
				if(empty($name)){
					...
					$errorMsg = "please Enter the Description of your post";	
						...
						$errorMsg = "Please Select Image";
				  		...
				  		if(!isset($errorMsg)){
				  			$insert_stmt = $connection->prepare('INSERT INTO temporary_vows(image, name, country, phone, email, description) VALUES(:image, :name, :country, :phone, :email, :description)'); // sql insert query
				  				...
				  				if($insert_stmt->execute()){
				  					...
				  					header("refresh:3;read_temporary_vows.php"); //refresh 3 second and redirext to the read page
				  				}
				  		}
