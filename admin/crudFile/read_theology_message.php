...
if(isset($_REQUEST['delete_id'])){
	...
	$delete_stmt = $connection->prepare('DELETE FROM theology WHERE id =:id');
	$delete_stmt->bindParam(':id',$id);
	$delete_stmt->execute();

	header("Location:read_theology_message.php");
}
		...
		<div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="create_theology_message.php"><span class="glyphicon glyphicon-plus"></span>&nbsp; Add message</a></h3>
                </div>
                        <!-- /.panel-heading -->
									...
									while($row=$select_stmt->fetch(PDO::FETCH_ASSOC))
									{
										?>
											...
											<tr>
												...
												<td><a href="edit_theology_message.php?update_id=<?php echo $row['id']; ?>" class="btn btn-warning">Edit</a></td>
