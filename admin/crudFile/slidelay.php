			...
			<div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           <h1 style="color: blue; text-align: center;">These are dynamic slides for lay assumptionists</h1>
                        </div>
                        <!-- /.panel-heading -->
				  		...
				  		if(!isset($errorMsg)){
				  			$insert_stmt = $connection->prepare('INSERT INTO slidelay(image) VALUES(:image)'); // sql insert query
				  				...
				  				if($insert_stmt->execute()){
				  					...
				  					header("refresh:3;create_slidelay.php"); //refresh 3 second and redirext to the read page
				  				}
				  		}
