			...
			<div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3><a href="create_pastoral.php"><span class="glyphicon glyphicon-plus"></span>&nbsp; Add Pastoral</a></h3>
                    </div>
							...
							<table class="table table-striped table-bordered table-hover" style="text-align: center;">
								<thead>
									<tr>
										...
										<th style="text-align: center;">Place of work</th>
								...
								<tbody>
									...
									<tr>
										...
										<td><a href="edit_pastoral.php?update_id=<?php echo $row['id']; ?>" class="btn btn-warning">Edit</a></td>
