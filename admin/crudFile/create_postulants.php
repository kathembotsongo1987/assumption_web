			...
			<div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h1 style="color: blue; text-align: center;">Current Postulant</h1>
                    </div>
									...
									<div class="col-sm-6">
										<label class="col-sm-6 control-label">Action</label>
											<input type="submit" name="btn_insert" class="btn btn-success" value="Insert">
												<a href="read_postulants.php" class="btn btn-danger">Cancel</a>
									</div>
								</div>
							</form>	
						</div>                            
				...
				if(empty($parish)){
					$errorMsg = "please Enter the Title of your post";					
						...
						$errorMsg = "Please Select Image";
				  		...
				  		if(!isset($errorMsg)){
				  			$insert_stmt = $connection->prepare('INSERT INTO postulants(image, name, country, diocese, parish) VALUES(:image, :name, :country, :diocese, :parish)'); // sql insert query
				  				...
				  				if($insert_stmt->execute()){
				  					...
				  					header("refresh:1;read_postulants.php"); //refresh 3 second and redirext to the read page
				  				}
				  		}
