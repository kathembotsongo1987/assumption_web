...
if(isset($_REQUEST['btn_update'])){
	try {
		...
		if(!isset($errorMsg)){
			$upldate_stmt = $connection->prepare('UPDATE slides_ecumenism SET title=:title_up, description=:description_up, Image=:file_up WHERE id=:id'); //slq update the query.
			...
			if($upldate_stmt->execute()){
				...
				header("refresh:1; read_slides_ecumenism.php");//reflesh 3 second and redirect to read.php page.
			}
		}
	}
	catch(PDOException $e){
