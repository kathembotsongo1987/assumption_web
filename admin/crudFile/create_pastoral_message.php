						 ...
						 <form method="post" class="form-horizontal" enctype="multipart/form-data">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label">Description 1</label>
									<div class="col-sm-6">
										<input type="text" name="description1" class="form-control" placeholder="">				
									</div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label">Description video</label>
									<div class="col-sm-6">
										<input type="text" name="descriptionvideo" class="form-control" placeholder="">				
									</div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label">Description 2</label>
									<div class="col-sm-6">
										<input type="text" name="description2" class="form-control" placeholder="">				
									</div>
							</div>
			...
			try
			{
				...
				if(empty($photo2)){
						$errorMsg = "Please Select Image 2";
				  		...
				  		if(!isset($errorMsg)){
				  			$insert_stmt = $connection->prepare('INSERT INTO pastoral_message(photo1, photo2, description1, description2, descriptionvideo, video) VALUES(:photo1, :photo2, :description1, :description2, :descriptionvideo, :video)'); // sql insert query
				  				...
				  				if($insert_stmt->execute()){
				  					...
				  					header("refresh:3;read_pastoral_message.php"); //refresh 3 second and redirext to the read page
				  				}
				  		}
