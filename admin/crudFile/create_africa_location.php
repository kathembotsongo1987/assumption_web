			...
			{				
				...
				if (empty($Country)) {
					...
					$errorMsg = "please Enter the number of communities";	
				  		...
				  		if(!isset($errorMsg)){
				  			$insert_stmt = $connection->prepare('INSERT INTO africa_location(country, no_community) VALUES(:country, :no_community)'); // sql insert query
				  				...
				  				if($insert_stmt->execute()){
				  					...
				  					header("refresh:3;read_africa_location.php"); //refresh 3 second and redirext to the read page
				  				}
				  		}
