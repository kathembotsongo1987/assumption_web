...
$sql = 'SELECT * FROM email_pavel_school';

$statement = $connection->prepare($sql);

$statement->execute();

$email_pavel_school = $statement->fetchAll(PDO::FETCH_OBJ);
            ...
            <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           <h3 style="text-transform: uppercase; text-align: center; color: blue;">box emails Pavel Primary School</h3>
                        </div>
                        <!-- /.panel-heading -->
                ...
                <?php foreach($email_pavel_school as $visitors): ?>
