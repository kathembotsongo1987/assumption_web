...
if(isset($_REQUEST['btn_update'])){
	try {
		...
		if(!isset($errorMsg)){
			$upldate_stmt = $connection->prepare('UPDATE postulants SET image=:image, name=:name, country=:country, diocese=:diocese, parish=:parish WHERE id=:id'); //slq update the query.
			...
			if($upldate_stmt->execute()){
				...
				header("refresh:1; read_postulants.php");//reflesh 3 second and redirect to read.php page.
			}
		}
	}
	catch(PDOException $e){
