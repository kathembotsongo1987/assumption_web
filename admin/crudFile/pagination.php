...
.btn-page.current{background:rgba(15,250,158,.2);}
</style> 
</head>
<body>
<?php	
	...
	$sql = 'SELECT * FROM email_assumption_high_school WHERE mail LIKE :keyword OR message LIKE :keyword OR sent LIKE :keyword ORDER BY id ASC ';
