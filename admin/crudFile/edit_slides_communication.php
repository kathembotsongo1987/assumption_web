...
if(isset($_REQUEST['btn_update'])){
	try {
		...
		if(!isset($errorMsg)){
			$upldate_stmt = $connection->prepare('UPDATE slides_communication SET title=:title_up, description=:description_up, Image=:file_up WHERE id=:id'); //slq update the query.
			...
			if($upldate_stmt->execute()){
				...
				header("refresh:1; read_slides_communication.php");//reflesh 1 second and redirect to read.php page.
			}
		}
	}
	catch(PDOException $e){
							...
							<form method="post" class="form-horizontal" enctype="multipart/form-data">
								...
								<div class="form-group">
									<label class="col-sm-3 control-label">Description</label>
										<div class="col-sm-6">
											<input type="text" name="txt_description" class="form-control" value=" <?php echo $description; ?>" required/>
										</div>
								</div>
