...
<table class="table table-striped table-bordered table-hover" style="text-align: center;">
	...
	<tbody>
		<?php 
			$select_stmt = $connection->prepare("SELECT * FROM provincial_administration"); //sql select query
			$select_stmt->execute();
			while($row=$select_stmt->fetch(PDO::FETCH_ASSOC))
			{
				?>
					...
					<tr>
						...
						<td><a href="edit_posthome.php?update_id=<?php echo $row['id']; ?>" class="btn btn-warning">Edit</a></td>
