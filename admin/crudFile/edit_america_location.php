...
if(isset($_REQUEST['btn_update'])){
		...
		$Communities = $_REQUEST['txt_community']; 
			...
			if($upldate_stmt->execute()){
				...
				header("refresh:3; read_america_location.php");//reflesh 3 second and redirect to read.php page.
			}
		}
 ?>
			...
			<div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           <h1 style="color: blue; text-align: center;">Dynamic date for the Province of Americ</h1>
                        </div>
                        <!-- /.panel-heading -->
