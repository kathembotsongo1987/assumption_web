...
if(isset($_REQUEST['delete_id'])){
	...
	$delete_stmt = $connection->prepare('DELETE FROM theologians WHERE id =:id');
			...
			<div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3><a href="create_theologians.php"><span class="glyphicon glyphicon-plus"></span>&nbsp; Add Theologian</a></h3>
                    </div>
                    <div class="panel-body">
                        <div class="table-responsive">
							<table class="table table-striped table-bordered table-hover" style="text-align: center;">
								...
								<tbody>
									<?php 
										$select_stmt = $connection->prepare("SELECT * FROM theologians"); //sql select query
										$select_stmt->execute();
									...
									<tr>
										...
										<td><a href="edit_theologians.php?update_id=<?php echo $row['id']; ?>" class="btn btn-warning">Edit</a></td>
