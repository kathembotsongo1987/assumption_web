...
if(isset($_REQUEST['delete_id'])){
	...
	header("Location:read_prov_community.php");
}
			...
			<div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           <h3><a href="create_prov_community.php"><span class="glyphicon glyphicon-plus"></span>&nbsp; Add Community</a></h3>
                        </div>
                        <!-- /.panel-heading -->
			...
			while($row=$select_stmt->fetch(PDO::FETCH_ASSOC))
			{
				?>
					...
					<tr>
						...
						<td><a href="edit_prov_community.php?update_id=<?php echo $row['id']; ?>" class="btn btn-warning">Edit</a></td>
