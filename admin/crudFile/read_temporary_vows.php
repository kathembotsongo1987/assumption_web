			...
			<div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           <h3><a href="create_temporary_vows.php"><span class="glyphicon glyphicon-plus"></span>&nbsp; Add religious with temporary vows</a></h3>
                        </div>
                        <!-- /.panel-heading -->
			...
			while($row=$select_stmt->fetch(PDO::FETCH_ASSOC))
			{
				?>
					...
					<tr>
						...
						<td><a href="edit_temporary_vows.php?update_id=<?php echo $row['id']; ?>" class="btn btn-warning">Edit</a></td>
