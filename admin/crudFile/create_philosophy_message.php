			...
			<div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h1 style="color: blue; text-align: center;"> Create Message</h1>
                    </div>                       
			...
			try
			{
				...
				if(empty($photo2)){
						$errorMsg = "Please Select Image 2";
				  		...
				  		if(!isset($errorMsg)){
				  			$insert_stmt = $connection->prepare('INSERT INTO philosophy_message(photo1, photo2, description1, description2, descriptionvideo, video) VALUES(:photo1, :photo2, :description1, :description2, :descriptionvideo, :video)'); // sql insert query
				  				...
				  				if($insert_stmt->execute()){
				  					...
				  					header("refresh:3;read_philosophy_message.php"); //refresh 3 second and redirext to the read page
				  				}
				  		}
