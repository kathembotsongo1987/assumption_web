			...
			try
			{
				...
				if(empty($photo2)){
						$errorMsg = "Please Select Image 2";
				  		...
				  		if(!isset($errorMsg)){
				  			$insert_stmt = $connection->prepare('INSERT INTO theology(photo1, photo2, description1, description2, descriptionvideo, video) VALUES(:photo1, :photo2, :description1, :description2, :descriptionvideo, :video)'); // sql insert query
				  				...
				  				if($insert_stmt->execute()){
				  					...
				  					header("refresh:3;read_theology_message.php"); //refresh 3 second and redirext to the read page
				  				}
				  		}
