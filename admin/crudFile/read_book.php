...
if(isset($_REQUEST['delete_id'])){
	...
	$delete_stmt = $connection->prepare('DELETE FROM book WHERE id =:id');
                ...
                <div class="panel-body">
                    <div class="table-responsive">
						<table class="table table-striped table-bordered table-hover" style="text-align: center;">
							...
							<tbody>
								<?php 
									$select_stmt = $connection->prepare("SELECT * FROM book"); //sql select query
									$select_stmt->execute();
								...
								?>
									...
									<tr>
										...
										<td><a href="edit_book.php?update_id=<?php echo $row['id']; ?>" class="btn btn-warning">Edit</a></td>
