...
if(isset($_REQUEST['btn_update'])){
	try {
		...
		if(!isset($errorMsg)){
			$upldate_stmt = $connection->prepare('UPDATE available_product SET title=:title_up, description=:description_up, image=:file_up WHERE id=:id'); //slq update the query.
			...
			if($upldate_stmt->execute()){
				...
				header("refresh:3; read_available_product.php");//reflesh 3 second and redirect to read.php page.
			}
		}
	}
	catch(PDOException $e){
