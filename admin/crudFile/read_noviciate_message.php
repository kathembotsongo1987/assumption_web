...
if(isset($_REQUEST['delete_id'])){
	...
	$delete_stmt = $connection->prepare('DELETE FROM noviciate_message WHERE id =:id');
	$delete_stmt->bindParam(':id',$id);
	$delete_stmt->execute();

	header("Location:read_noviciate_message.php");
}
		...
		<div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="create_noviciate_message.php"><span class="glyphicon glyphicon-plus"></span>&nbsp; Add message</a></h3>
                </div>
                        <!-- /.panel-heading -->
                <div class="panel-body">
                    <div class="table-responsive">
						<table class="table table-striped table-bordered table-hover" style="text-align: center;">
							...
							<tbody>
								<?php 
									$select_stmt = $connection->prepare("SELECT * FROM noviciate_message"); //sql select query
									$select_stmt->execute();
									while($row=$select_stmt->fetch(PDO::FETCH_ASSOC))
									{
										?>
											...
											<tr>
												...
												<td><a href="edit_noviciate_message.php?update_id=<?php echo $row['id']; ?>" class="btn btn-warning">Edit</a></td>
