...
if(isset($_REQUEST['btn_update'])){
	try {
		...
		if(!isset($errorMsg)){
			$upldate_stmt = $connection->prepare('UPDATE slidelay SET image=:file_up WHERE id=:id'); //slq update the query.
			...
			if($upldate_stmt->execute()){
				...
				header("refresh:3; read_slidelay.php");//reflesh 3 second and redirect to read.php page.
			}
		}
	}
	catch(PDOException $e){
			...
			<div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           <h3><a href="creat_post_H_Page.php"><span class="glyphicon glyphicon-plus"></span>&nbsp; Add new slide for lay assumptionist</a></h3>
                        </div>
                        <!-- /.panel-heading -->
