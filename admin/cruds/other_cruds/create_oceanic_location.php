			...
			try{	
				...
				if (empty($Country)) {
					...
					$errorMsg = "please Enter the number of communities";	
				  		...
				  		if(!isset($errorMsg)){
				  			$insert_stmt = $connection->prepare('INSERT INTO oceanic_location(country, no_community) VALUES(:country, :no_community)'); // sql insert query
				  				...
				  				if($insert_stmt->execute()){
				  					...
				  					header("location:read_oceanic_location.php"); //refresh 3 second and redirext to the read page
				  				}
				  		}
				}
								...
								<div class="col-sm-6">
									<label class="col-sm-6 control-label">Action</label>
										<input type="submit" name="btn_insert" class="btn btn-success" value="Insert">
											<a href="read_oceanic_location.php" class="btn btn-danger">Cancel</a>
								</div>
							</div>
						</form>	
					</div>
