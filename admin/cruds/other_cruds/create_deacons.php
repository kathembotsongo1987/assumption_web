				...
				if(empty($name)){
					...
					$errorMsg = "please Enter date for diaconate";	
						...
						$errorMsg = "Please Select Image";
				  		...
				  		if(!isset($errorMsg)){
				  			$insert_stmt = $connection->prepare('INSERT INTO deacons(image, name, country, diocese, community, temporary_vows, perpetual_vows, phone, email, diaconate_date) VALUES(:image, :name, :country, :diocese, :community, :temp_v, :perp_v, :phone, :email, :diaconate_date)'); // sql insert query
				  				...
				  				if($insert_stmt->execute()){
				  					...
				  					header("location:read_deacons.php"); //refresh 3 second and redirext to the read page
				  				}
				  		}
