		...
		<div class="col-lg-12">
			<div class="panel panel-default">
                    <div class="panel-heading">
                    	<h1 style="text-align: center;">RELIGIOUS IN TANZANIA</h1>
                    </div>
                <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover" style="text-align: center;">
                                ...
                                <tbody>
                                    <?php 
                                        $select_stmt = $connection->prepare("SELECT * FROM religious_tb where cur_country='tanzania'"); //sql select query
                                        $select_stmt->execute();
