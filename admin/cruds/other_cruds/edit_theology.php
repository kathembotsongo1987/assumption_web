	...
	try {
		...
		if(!isset($errorMsg)){
			...
			if($upldate_stmt->execute()){
				...
				header("location: read_theology.php");//reflesh 3 second and redirect to read.php page.
			}
		}
	}
	catch(PDOException $e){
			...
			<div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h1 style="text-align: center;">DATA MANIPULATION || THEOLOGY</h1>
                    </div>                       
								...
								<div class="col-sm-6">
									<label class="col-sm-6 control-label">Action</label>
										<input type="submit" name="btn_update" class="btn btn-success" value="update">
											<a href="read_theology.php" class="btn btn-danger">Cancel</a>
								</div>
							</div>
						</form>	
					</div> 
