...
if(isset($_REQUEST['delete_id'])){
	...
	header("Location:read_theology.php");
}
		...
		<div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="create_theology.php"><span class="glyphicon glyphicon-plus"></span>&nbsp; Add</a></h3>
                </div>
                <!-- /.panel-heading -->
						...
						<table class="table table-striped table-bordered table-hover" style="text-align: center;">
							...
							<?php 
								...
								<tr>
									...
									<td><a href="edit_theology.php?update_id=<?php echo $row['id']; ?>" class="btn btn-warning">Edit</a></td>
