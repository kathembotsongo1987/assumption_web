		...
		<div class="col-lg-12">
		    <div class="panel panel-default">
                <div class="panel-heading">
                    <h1 style="text-align: center;">DATA MANIPULATION || COMMUNITIES OF UGANDA</h1>
                    <h3><a href="create_cty_uganda.php"><span class="glyphicon glyphicon-plus"></span>&nbsp; Add New data</a></h3>
                </div>
