...
if(isset($_REQUEST['delete_id'])){
	...
	$delete_stmt = $connection->prepare('DELETE FROM orders WHERE id =:id');
		...
		<div class="col-lg-12">
			<div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <h3><a href="create_orders.php"><span class="glyphicon glyphicon-plus"></span>&nbsp; Add File</a></h3>
                    </div>
							...
							<table class="table table-striped table-bordered table-hover" style="text-align: center;">
								...
								<tbody>
									...
									<tr>
										...
										<td><a href="edit_orders.php?update_id=<?php echo $row['id']; ?>" class="btn btn-warning">Edit</a></td>
