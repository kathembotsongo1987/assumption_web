...
if(isset($_REQUEST['btn_update'])){
	try {
		...
		if(!isset($errorMsg)){
			$upldate_stmt = $connection->prepare('UPDATE post_philosophers SET	image=:image, name=:name, country=:country WHERE id=:id'); // sql insert query
		...
		<div class="col-lg-12">
			 <div class="panel panel-default">
                    <div class="panel-heading">
                    	<h1 style="text-align: center;">DATA MANIPULATION || POST PHILOSOPHERS</h1>
                    </div>
