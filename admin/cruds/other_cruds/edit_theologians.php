...
if(isset($_REQUEST['btn_update'])){
	try {
		...
		if(!isset($errorMsg)){
			$upldate_stmt = $connection->prepare('UPDATE theologians SET	image=:image, name=:name, country=:country, diocese=:diocese, parish=:parish, temporary_vows=:temp_v, perpetual_vows=:perp_v, phone=:phone, email=:email WHERE id=:id'); // sql insert query
                        ...
                        <div class="table-responsive">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label">Parish</label>
									<div class="col-sm-6">
										<input type="text" name="parish" value=" <?php echo $parish ?> "	 class="form-control" placeholder="enter parish ">
									</div>
							</div>
							<div class="form-group">
