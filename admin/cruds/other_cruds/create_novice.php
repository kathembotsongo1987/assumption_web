				...
				if(empty($name)){
					...
					$errorMsg = "please Enter the country";	
						...
						$errorMsg = "Please Select Image";
				  		...
				  		if(!isset($errorMsg)){
				  			$insert_stmt = $connection->prepare('INSERT INTO novices(image, name, country) VALUES(:image, :name, :country)'); // sql insert query
				  				...
				  				if($insert_stmt->execute()){
				  					...
				  					header("location:read_novice.php"); //refresh 3 second and redirext to the read page
				  				}
				  		}
		...
		<div class="col-lg-12">
			<div class="panel panel-default">
                <div class="panel-heading">
                	<h1>DATA MANIPULATION || NOVICE</h1>
                    <h3><a href="read_novice.php"><span class="glyphicon glyphicon-plus"></span>&nbsp; Add File</a></h3>
                </div>
								...
								<div class="col-sm-6">
									<label class="col-sm-6 control-label">Action</label>
										<input type="submit" name="btn_insert" class="btn btn-success" value="Insert">
											<a href="read_novice.php" class="btn btn-danger">Cancel</a>
								</div>
							</div>
						</form>	
					</div>
