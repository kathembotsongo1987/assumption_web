		...
		<div class="col-lg-12">
			<div class="panel panel-default">
                    <div class="panel-heading">
                    	<h1 style="text-align: center;">CURRENT DEACONS IN THE VICE PROVINCE</h1>
                    </div>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align: center;">Date diaconate</th>
                                ...
                                <tbody>
                                    <?php 
                                        $select_stmt = $connection->prepare("SELECT * FROM religious_tb where status='diaconate'"); //sql select query
                                        $select_stmt->execute();
