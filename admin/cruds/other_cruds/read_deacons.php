...
<?php
	...
	$delete_stmt = $connection->prepare('DELETE FROM deacons WHERE id =:id');
	$delete_stmt->bindParam(':id',$id);
	$delete_stmt->execute();

	header("Location:read_deacons.php");
}
		...
		<div class="col-lg-12">
			<div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <h3><a href="create_deacons.php"><span class="glyphicon glyphicon-plus"></span>&nbsp; Add File</a></h3>
                    </div>
                    <div class="panel-body">
                        <div class="table-responsive">
							<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
								...
								<tbody>
									<?php 
										$select_stmt = $connection->prepare("SELECT * FROM deacons"); //sql select query
										$select_stmt->execute();
									...
									<tr>
										...
										<td><a href="edit_deacons.php?update_id=<?php echo $row['id']; ?>" class="btn btn-warning">Edit</a></td>
