...
if(isset($_REQUEST['delete_id'])){
	...
	$delete_stmt = $connection->prepare('DELETE FROM rule WHERE id =:id');
	$delete_stmt->bindParam(':id',$id);
	$delete_stmt->execute();

	header("Location:read_rule.php");
}
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
							<table class="table table-striped table-bordered table-hover" style="text-align: center;">
								...
								<tbody>
									<?php 
										$select_stmt = $connection->prepare("SELECT * FROM rule"); //sql select query
										$select_stmt->execute();
									...
									<tr>
										...
										<td><a href="edit_rule.php?update_id=<?php echo $row['id']; ?>" class="btn btn-warning">Edit</a></td>
