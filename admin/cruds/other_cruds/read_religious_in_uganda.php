...
if(isset($_REQUEST['delete_id'])){
	...
	$select_stmt = $connection->prepare('SELECT * FROM religious_in_uganda WHERE id =:id'); // sql select query
	...
	$delete_stmt = $connection->prepare('DELETE FROM religious_in_uganda WHERE id =:id');
	$delete_stmt->bindParam(':id',$id);
	$delete_stmt->execute();

	header("Location:read_religious_in_uganda.php");
}
		...
		<div class="col-lg-12">
			<div class="panel panel-default">
                    <div class="panel-heading">
                    	<h1 style="text-align: center;">DATA MANIPULATION || RELIGIOUS IN UGANDA</h1>
                        <h3><a href="create_religious_in_uganda.php"><span class="glyphicon glyphicon-plus"></span>&nbsp; Add File</a></h3>
                    </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" style="text-align: center;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="edit_religious_in_uganda.php?update_id=<?php echo $row['id']; ?>" class="btn btn-warning"><i class="fas fa-edit"></i></a></td>
