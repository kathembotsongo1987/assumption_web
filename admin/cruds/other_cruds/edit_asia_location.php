...
if(isset($_REQUEST['btn_update'])){
		...
		$Communities = $_REQUEST['txt_community']; 
			...
			$upldate_stmt = $connection->prepare('UPDATE asia_location SET country=:country_up, no_community=:no_community_up WHERE id=:id'); //slq update the query.
			...
			if($upldate_stmt->execute()){
				...
				header("refresh:1; read_asia_location.php");//reflesh 3 second and redirect to read.php page.
			}
		}
 ?>
								...
								<div class="col-sm-6">
									<label class="col-sm-6 control-label">Action</label>
										<input type="submit" name="btn_update" class="btn btn-success" value="update">
											<a href="read_asia_location.php" class="btn btn-danger">Cancel</a>
								</div>
							</div>
						</form>	
					</div>
