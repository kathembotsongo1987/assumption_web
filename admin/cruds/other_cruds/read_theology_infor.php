...
if(isset($_REQUEST['delete_id'])){
	...
	$delete_stmt = $connection->prepare('DELETE FROM theology_infor WHERE id =:id');
	$delete_stmt->bindParam(':id',$id);
	$delete_stmt->execute();

	header("Location:read_theology_infor.php");
}
		...
		<div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="create_theology_infor.php"><span class="glyphicon glyphicon-plus"></span>&nbsp; Add News</a></h3>
                </div>
                <!-- /.panel-heading -->
						...
						<table class="table table-striped table-bordered table-hover" style="text-align: center;">
							...
							<?php 
								...
								<tr>
									...
									<td><a href="edit_theology_infor.php?update_id=<?php echo $row['id']; ?>" class="btn btn-warning">Edit</a></td>
