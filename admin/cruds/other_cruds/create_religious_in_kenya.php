				...
				if(empty($name)){
					...
					$errorMsg = "please Enter password";	
						...
						$errorMsg = "Please Select Image";
				  		...
				  		if(!isset($errorMsg)){
				  			$insert_stmt = $connection->prepare('INSERT INTO religious_in_kenya(image, name, country, community, temp_v_date, perp_v_date, deaconate_date, priesthood_date, phone, email, password) VALUES(:image, :name, :country, :community, :temp_v_date, :perp_v_date, :deaconate_date, :priesthood_date, :phone, :email, :password)'); // sql insert query
				  				...
				  				if($insert_stmt->execute()){
				  					...
				  					header("location:read_religious_in_kenya.php"); //refresh 3 second and redirext to the read page
				  				}
				  		}
				}
