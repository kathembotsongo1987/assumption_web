				...
				if(empty($name)){
					...
					$errorMsg = "please Enter a message";	
						...
						$errorMsg = "Please Select Image";
				  		...
				  		if(!isset($errorMsg)){
				  			$insert_stmt = $connection->prepare('INSERT INTO orders(image, name, country, community, temp_v_date, perp_v_date, deaconate_date, priesthood_date,message) VALUES(:image, :name, :country, :community, :temp_v_date, :perp_v_date, :deaconate_date, :priesthood_date, :message)'); // sql insert query
				  				...
				  				if($insert_stmt->execute()){
				  					...
				  					header("location:read_orders.php"); //refresh 3 second and redirext to the read page
				  				}
				  		}
						...
						<form method="post" class="form-horizontal" enctype="multipart/form-data">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label">Date for priesthood</label>
									<div class="col-sm-6">
										<input type="text" name="priesthood_date" class="form-control" placeholder="enter Description">
									</div>
							</div>
							<div class="form-group">
