...
if(isset($_REQUEST['btn_update'])){
	try {
		...
		if(!isset($errorMsg)){
			$upldate_stmt = $connection->prepare('UPDATE pastoral SET	image=:image, name=:name, country=:country, community=:community, temporary_vows=:temp_v, phone=:phone, email=:email WHERE id=:id'); // sql insert query
			...
			if($upldate_stmt->execute()){
				...
				header("location: read_pastoral.php");
			}
		}
	}
	catch(PDOException $e){
		...
		<div class="col-lg-12">
			 <div class="panel panel-default">
                    <div class="panel-heading">
                    	<h1 style="text-align: center;">DATA MANIPULATION || PASTORAL EXPERIENCE</h1>
                    </div>
                        ...
                        <div class="table-responsive">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label">Community</label>
									<div class="col-sm-6">
										<input type="text" name="community" value=" <?php echo $community ?> "	 class="form-control" placeholder="enter community ">
									</div>
							</div>
							<div class="form-group">
