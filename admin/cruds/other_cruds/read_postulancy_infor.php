...
if(isset($_REQUEST['delete_id'])){
	...
	$delete_stmt = $connection->prepare('DELETE FROM postulancy_infor WHERE id =:id');
	$delete_stmt->bindParam(':id',$id);
	$delete_stmt->execute();

	header("Location:read_postulancy_infor.php");
}
		...
		<div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="create_postulancy_infor.php"><span class="glyphicon glyphicon-plus"></span>&nbsp; Add Postulancy News</a></h3>
                </div>
                <!-- /.panel-heading -->
                <div class="panel-body">
                    <div class="table-responsive">
						<table class="table table-striped table-bordered table-hover" style="text-align: center;">
							...
							<tbody>
							<?php 
								$select_stmt = $connection->prepare("SELECT * FROM postulancy_infor"); //sql select query
								$select_stmt->execute();
								...
								<tr>
									...
									<td><a href="edit_postulancy_infor.php?update_id=<?php echo $row['id']; ?>" class="btn btn-warning">Edit</a></td>
