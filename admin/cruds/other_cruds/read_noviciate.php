...
if(isset($_REQUEST['delete_id'])){
	...
	$delete_stmt = $connection->prepare('DELETE FROM noviciate WHERE id =:id');
	$delete_stmt->bindParam(':id',$id);
	$delete_stmt->execute();

	header("Location:read_noviciate.php");
}
		...
		<div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="create_noviciate.php"><span class="glyphicon glyphicon-plus"></span>&nbsp; Add Noviciate message</a></h3>
                </div>
                <!-- /.panel-heading -->
						...
						<table class="table table-striped table-bordered table-hover" style="text-align: center;">
							...
							<?php 
								...
								<tr>
									...
									<td><a href="edit_noviciate.php?update_id=<?php echo $row['id']; ?>" class="btn btn-warning">Edit</a></td>
