				...
				if(empty($Title)){
					...
					$errorMsg = "please Enter the Description of your post";	
						...
						$errorMsg = "Please Select Image";
				  		...
				  		if(!isset($errorMsg)){
				  			$insert_stmt = $connection->prepare('INSERT INTO general_council(image, title, description) VALUES(:image, :title, :description)'); // sql insert query
				  				...
				  				if($insert_stmt->execute()){
				  					...
				  					header("location:read_gen_council.php"); //refresh 3 second and redirext to the read page
				  				}
				  		}
                ...
                <div class="panel-body">
                    <div class="table-responsive">
						<form method="post" class="form-horizontal" enctype="multipart/form-data">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label">Name and Title</label>
									<div class="col-sm-6">
										<input type="text" name="txt_title" class="form-control" placeholder="enter name">
									</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label">Description of Message</label>
									<div class="col-sm-6">
