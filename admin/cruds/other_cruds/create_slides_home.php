				...
				if(empty($Title)){
					...
					$errorMsg = "please Enter the Description of your post";	
						...
						$errorMsg = "Please Select Image";
				  		...
				  		if(!isset($errorMsg)){
				  			$insert_stmt = $connection->prepare('INSERT INTO slideshome(image, title, smalltext) VALUES(:image, :title, :smalltext)'); // sql insert query
				  				...
				  				if($insert_stmt->execute()){
				  					...
				  					header("location:read_slides_home.php"); //refresh 3 second and redirext to the read page
				  				}
				  		}
