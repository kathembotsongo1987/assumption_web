				...
				if(empty($name)){
					...
					$errorMsg = "please Enter date for his priesthood";	
						...
						$errorMsg = "Please Select Image";
				  		...
				  		if(!isset($errorMsg)){
				  			$insert_stmt = $connection->prepare('INSERT INTO priests(image, name, country, community, temp_v_date, perp_v_date, deaconate_date, priesthood_date) VALUES(:image, :name, :country, :community, :temp_v_date, :perp_v_date, :deaconate_date, :priesthood_date)'); // sql insert query
