...
if(isset($_REQUEST['delete_id'])){
	...
	header("Location:read_religious_in_kenya.php");
}
		...
		<div class="col-lg-12">
			<div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <h3><a href="create_religious_in_kenya.php"><span class="glyphicon glyphicon-plus"></span>&nbsp; Add File</a></h3>
                    </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" style="text-align: center;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="edit_religious_profile_tanzania.php?update_id=<?php echo $row['id']; ?>" class="btn btn-warning"><i class="fas fa-edit"></i></a></td>
                                        <td>
