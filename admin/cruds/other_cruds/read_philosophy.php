...
if(isset($_REQUEST['delete_id'])){
	...
	$delete_stmt = $connection->prepare('DELETE FROM philosophy WHERE id =:id');
	$delete_stmt->bindParam(':id',$id);
	$delete_stmt->execute();

	header("Location:read_philosophy.php");
}
		...
		<div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="create_philosophy.php"><span class="glyphicon glyphicon-plus"></span>&nbsp; Add</a></h3>
                </div>
                <!-- /.panel-heading -->
						...
						<table class="table table-striped table-bordered table-hover" style="text-align: center;">
							...
							<?php 
								...
								<tr>
									...
									<td><a href="edit_philosophy.php?update_id=<?php echo $row['id']; ?>" class="btn btn-warning">Edit</a></td>
