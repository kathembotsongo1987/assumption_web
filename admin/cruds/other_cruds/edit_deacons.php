...
if(isset($_REQUEST['btn_update'])){
	try {
		...
		if(!isset($errorMsg)){
			$upldate_stmt = $connection->prepare('UPDATE deacons SET	image=:image, name=:name, country=:country, community=:community, temporary_vows=:temp_v, perpetual_vows=:perp_v, diaconate_date=:diaconate_date, phone=:phone, email=:email WHERE id=:id'); // sql insert query
