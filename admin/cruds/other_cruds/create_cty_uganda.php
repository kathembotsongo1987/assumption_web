			...
			{				
				...
				if(empty($name)){
					$errorMsg = "please Enter the name";					
				  		...
				  		if(!isset($errorMsg)){
				  			$insert_stmt = $connection->prepare('INSERT INTO communitiesuganda(name, diocese) VALUES(:name, :diocese)'); 
				  				...
				  				if($insert_stmt->execute()){
				  					...
				  					header("refresh:1;read_cty_uganda.php"); //refresh 3 second and redirext to the read page
				  				}
				  		}
		...
		<div class="col-lg-12">
			<div class="panel panel-default">
                <div class="panel-heading">
                    <h1 style="color: blue; text-align: center;">DATA MANIPULATION || COMMUNITIES UGANDA</h1>
                </div>
