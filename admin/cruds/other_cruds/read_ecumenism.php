...
<?php 
 if(isset($_REQUEST['delete_id'])){
	...
	$delete_stmt = $connection->prepare('DELETE FROM ecumenism WHERE id =:id');
	...
	<div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3><a href="create_ecumenism.php"><span class="glyphicon glyphicon-plus"></span>&nbsp; Add file</a></h3>
            </div>
        </div>
        <div class="panel-body">
            <div class="table-responsive">
				<table class="table table-striped table-bordered table-hover" style="text-align: center;">
					<thead>
						<tr>
							<th style="text-align: center;">Ecumenism image</th>			
					...
					<tbody>
						<?php 
							...
							<tr>
								<td><img src="upload/<?php echo $row['ecumenism_image']; ?>" width="100px" height="60px"></td>					
								...
								<td><a href="edit_ecumenism.php?update_id=<?php echo $row['id']; ?>" class="btn btn-warning">Edit</a></td>
