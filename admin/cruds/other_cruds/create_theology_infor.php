			...
			try{
				...
				if(empty($photo2)){
						$errorMsg = "Please Select Image 2";
				  		...
				  		if(!isset($errorMsg)){
				  			$insert_stmt = $connection->prepare('INSERT INTO theology_infor(photo1, photo2, description1, description2, article) VALUES(:photo1, :photo2, :description1, :description2, :article)'); // sql insert query
				  				...
				  				if($insert_stmt->execute()){
				  					...
				  					header("location:read_theology_infor.php"); //refresh 3 second and redirext to the read page
				  				}
				  		}
