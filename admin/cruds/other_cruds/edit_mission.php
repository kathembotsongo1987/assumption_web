...
if(isset($_REQUEST['btn_update'])){
	try {
		...
		if(!isset($errorMsg)){
			$upldate_stmt = $connection->prepare('UPDATE mission SET	image=:image, name=:name, country=:country, mission=:mission, community=:community, temporary_vows=:temp_v, perpetual_vows=:perp_v, phone=:phone, email=:email,diaconate_date=:diaconate_date, priesthood_date=:priesthood_date WHERE id=:id'); // sql insert query
			...
			$upldate_stmt->bindParam(':mission', $mission);			
                        ...
                        <div class="table-responsive">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label">Mission</label>
									<div class="col-sm-6">
										<input type="text" name="mission" value=" <?php echo $mission ?> "	 class="form-control" placeholder="enter diocese ">
									</div>
							</div>	
							<div class="form-group">
