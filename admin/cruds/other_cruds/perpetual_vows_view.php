		...
		<div class="col-lg-12">
			<div class="panel panel-default">
                    <div class="panel-heading">
                    	<h1 style="text-align: center;">RELIGIOUS WITH PERPETUAL VOWS</h1>
                    </div>
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                                ...
                                <tbody>
                                    <?php 
                                        $select_stmt = $connection->prepare("SELECT * FROM religious_tb WHERE perp_v_date!='null'"); //sql select query
                                        $select_stmt->execute();
