				...
				if(empty($name)){
					...
					$errorMsg = "please Enter parish";	
						...
						$errorMsg = "Please Select Image";
				  		...
				  		if(!isset($errorMsg)){
				  			$insert_stmt = $connection->prepare('INSERT INTO post_philosophers(image, name, country, diocese, parish) VALUES(:image, :name, :country, :diocese, :parish)'); // sql insert query
				  				...
				  				if($insert_stmt->execute()){
				  					...
				  					header("location:read_post_philosophers.php"); //refresh 3 second and redirext to the read page
				  				}
				  		}
		...
		<div class="col-lg-12">
			<div class="panel panel-default">
                <div class="panel-heading">
                	<h1>DATA MANIPULATION || POST PHILOSPHERS</h1>
                </div>
								...
								<div class="col-sm-6">
									<label class="col-sm-6 control-label">Action</label>
										<input type="submit" name="btn_insert" class="btn btn-success" value="Insert">
											<a href="read_post_philosophers.php" class="btn btn-danger">Cancel</a>
								</div>
							</div>
						</form>	
					</div>
